...
#  docker_login_command              = "aws ecr get-login-password --region ${var.region} --profile default | docker login --username admin-ronm --password-stdin ${local.account_id}.dkr.ecr.${var.region}.amazonaws.com"
